package lattice.swiat;

import frame.SimulatorFrame;
import lattice.PanelLattice;
import swiat.organizm.Organizm;
import swiat.organizm.organizmy.rosliny.*;
import swiat.organizm.organizmy.zwierze.*;

import java.util.ArrayList;

public class SwiatLattice extends PanelLattice {
    ...
    public SwiatLattice(int x_size, int y_size, int infPanelHeight, SimulatorFrame frame, boolean newGame){
